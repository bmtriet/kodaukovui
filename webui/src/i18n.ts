...
export const translations = {
  en: {
    ...
    debug: "Debug logging",
    responseFallback: "Open chat when paste is not possible",
    responseFallbackHint: "When the target app has no text input, clipBo opens the result in a chat so you can continue the conversation.",
  ...
  vi: {
    ...
    debug: "Bật debug log",
    responseFallback: "Mở chat khi không paste được",
    responseFallbackHint: "Khi app đích không có ô nhập liệu, clipBo mở kết quả trong chat để bạn trao đổi tiếp.",
    providerLabel: "AI Provider",
    geminiKey: "Gemini API Key",
    geminiModel: "Gemini Model",
    openaiKey: "OpenAI API Key",
  ...
  zh: {
    ...
    uiLanguage: "界面语言",
    debug: "调试日志",
    responseFallback: "无法粘贴时打开聊天",
    responseFallbackHint: "当目标应用没有文本输入框时，clipBo 在聊天中显示结果，方便继续对话。",
    providerLabel: "AI Provider",
    geminiKey: "Gemini API Key",
    geminiModel: "Gemini Model",
    openaiKey: "OpenAI API Key",
